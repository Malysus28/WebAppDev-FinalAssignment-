        ...
        <div class="mt-4">
            <label for="consent" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600">
                    I agree to the
                    <a class="text-indigo-600 underline" href="{{ route('terms') }}" target="_blank">Terms of Use</a>
                    and
                    <a class="text-indigo-600 underline" href="{{ route('privacy') }}" target="_blank">Privacy Policy</a>.
                </span>
            </label>
